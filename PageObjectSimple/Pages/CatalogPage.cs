...
public class CatalogPage : BasePage
{
    ...
    private static readonly By AddToCartButtonBy = By.Id("add-to-cart-sauce-labs-bike-light");
    private static readonly By RemoveToCartButtonBy = By.Id("remove-sauce-labs-bike-light");
